...
const VectorSpaceVisualization: React.FC<VectorSpaceVisualizationProps> = ({
  concept,
  step = 0,
}) => {
  ...
  const renderVectorSpace = () => (
    <div className="relative w-full h-96 bg-gray-50 border-2 border-gray-200 rounded-lg overflow-hidden">
      ...
      <svg className="absolute inset-0 w-full h-full">
        ...
        {/* Axis labels */}
        <text x="390" y="210" className="text-sm font-medium fill-gray-600">
          x₁
        </text>
        <text x="210" y="15" className="text-sm font-medium fill-gray-600">
          x₂
        </text>
      </svg>
  ...
  const renderVectorOperations = () => {
    const [operation, setOperation] = useState<"addition" | "scalar" | "dot">(
      "addition",
    );
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              ...
              {operation === "scalar" && (
                <div className="text-sm">
                  ...
                  <div className="text-gray-600 mt-1">
                    Scalar multiplication changes magnitude, preserves direction
                  </div>
                </div>
              )}
            </div>
